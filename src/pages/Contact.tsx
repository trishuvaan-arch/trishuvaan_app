...
import { Mail, MapPin, Globe, Send, MessageCircle } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-600"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-600 resize-none"
                    placeholder="Tell us how we can help you..."
                  />
                </div>

                <GlowButton type="submit" className="w-full" icon={Send} disabled={isSubmitting}>
        ...
        >
          <div className="glass-effect rounded-2xl p-8">
            ...
            <div className="aspect-video rounded-xl overflow-hidden w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d243647.3160355435!2d78.24323159999999!3d17.4123487!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb99daeaebd2c7%3A0xae93b78392bafbc2!2sHyderabad%2C%20Telangana!5e0!3m2!1sen!2sin!4v1234567890123"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
